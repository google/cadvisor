...
func (f *systemdFactory) NewContainerHandler(name string, inHostNamespace bool) (container.Handler, error) {
...
func Register(machineInfoFactory info.MachineInfoFactory, fsInfo fs.Info, includedMetrics container.MetricSet) error {
