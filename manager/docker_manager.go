...
func newDockerManager(memoryCache *memory.InMemoryCache, sysfs sysfs.SysFs, maxHousekeepingInterval time.Duration, allowDynamicHousekeeping bool) (Manager, error) {
	if memoryCache == nil {
...
func (self *docker_manager) Start() error {
...
func (self *docker_manager) Stop() error {
...
func (self *docker_manager) globalHousekeeping(quit chan error) {
...
func (self *docker_manager) getContainerData(containerName string) (*containerData, error) {
...
func (self *docker_manager) GetDerivedStats(containerName string, options v2.RequestOptions) (map[string]v2.DerivedStats, error) {
...
func (self *docker_manager) GetContainerSpec(containerName string, options v2.RequestOptions) (map[string]v2.ContainerSpec, error) {
	conts, err := self.getRequestedContainers(containerName, options)
	if err != nil {
		return nil, err
	}
...
func (self *docker_manager) getV2Spec(cinfo *containerInfo) v2.ContainerSpec {
	spec := self.getAdjustedSpec(cinfo)
	return v2.ContainerSpecFromV1(&spec, cinfo.Aliases, cinfo.Namespace)
}

func (self *docker_manager) getAdjustedSpec(cinfo *containerInfo) info.ContainerSpec {
	spec := cinfo.Spec
...
func (self *docker_manager) GetContainerInfo(containerName string, query *info.ContainerInfoRequest) (*info.ContainerInfo, error) {
...
func (self *docker_manager) GetContainerInfoV2(containerName string, options v2.RequestOptions) (map[string]v2.ContainerInfo, error) {
...
func (self *docker_manager) containerDataToContainerInfo(cont *containerData, query *info.ContainerInfoRequest) (*info.ContainerInfo, error) {
...
func (self *docker_manager) getContainer(containerName string) (*containerData, error) {
	self.containersLock.RLock()
	defer self.containersLock.RUnlock()
...
func (self *docker_manager) getSubcontainers(containerName string) map[string]*containerData {
	self.containersLock.RLock()
	defer self.containersLock.RUnlock()
...
func (self *docker_manager) SubcontainersInfo(containerName string, query *info.ContainerInfoRequest) ([]*info.ContainerInfo, error) {
...
func (self *docker_manager) getAllDockerContainers() map[string]*containerData {
	self.containersLock.RLock()
	defer self.containersLock.RUnlock()
...
func (self *docker_manager) AllDockerContainers(query *info.ContainerInfoRequest) (map[string]info.ContainerInfo, error) {
...
func (self *docker_manager) getDockerContainer(containerName string) (*containerData, error) {
	self.containersLock.RLock()
	defer self.containersLock.RUnlock()
...
func (self *docker_manager) DockerContainer(containerName string, query *info.ContainerInfoRequest) (info.ContainerInfo, error) {
...
func (self *docker_manager) containerDataSliceToContainerInfoSlice(containers []*containerData, query *info.ContainerInfoRequest) ([]*info.ContainerInfo, error) {
	if len(containers) == 0 {
...
func (self *docker_manager) GetRequestedContainersInfo(containerName string, options v2.RequestOptions) (map[string]*info.ContainerInfo, error) {
	containers, err := self.getRequestedContainers(containerName, options)
	if err != nil {
		return nil, err
	}
...
func (self *docker_manager) getRequestedContainers(containerName string, options v2.RequestOptions) (map[string]*containerData, error) {
...
func (self *docker_manager) GetFsInfo(label string) ([]v2.FsInfo, error) {
	var empty time.Time
...
func (m *docker_manager) GetMachineInfo() (*info.MachineInfo, error) {
	// Copy and return the MachineInfo.
	return &m.machineInfo, nil
}

func (m *docker_manager) GetVersionInfo() (*info.VersionInfo, error) {
...
func (m *docker_manager) Exists(containerName string) bool {
...
func (m *docker_manager) GetProcessList(containerName string, options v2.RequestOptions) ([]v2.ProcessInfo, error) {
...
func (m *docker_manager) registerCollectors(collectorConfigs map[string]string, cont *containerData) error {
...
// Create a container.
func (m *docker_manager) createContainer(containerName string) error {
...
func (m *docker_manager) destroyContainer(containerName string) error {
	m.containersLock.Lock()
	defer m.containersLock.Unlock()
...
func (m *docker_manager) getContainersDiff(containerName string) (added []info.ContainerReference, removed []info.ContainerReference, err error) {
...
func (m *docker_manager) detectSubcontainers(containerName string) error {
...
func (self *docker_manager) watchForNewContainers(quit chan error) error {
...
func (self *docker_manager) watchForNewOoms() error {
...
func (m *docker_manager) DockerImages() ([]DockerImage, error) {
...
func (m *docker_manager) DockerInfo() (DockerStatus, error) {
...
func (m *docker_manager) DebugInfo() map[string][]string {
